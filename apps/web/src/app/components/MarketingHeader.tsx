    ...
    <header className="site-nav" style={{ position: "relative" }}>
      <div className="brand-wrapper">
        <a className="brand" href="/" style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 0 }}>
          ...
          <span className="logo-tagline" style={{ fontSize: "0.58rem", color: "#94a3b8", fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase", marginTop: "-2px", marginLeft: "2.75rem" }}>

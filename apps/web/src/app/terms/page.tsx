        ...
        {settings.policyTerms ? (
          ...
          <>
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <p>
                By accessing and using CursorWebs ("Service"), you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use the Service.
              </p>
            </section>
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <p>
                You must provide accurate account information. You are solely responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. CursorWebs reserves the right to terminate accounts that violate platform policies.
              </p>
            </section>
            ...
            <section style={{ marginBottom: "2rem" }}>
              ...
              <p>
                CursorWebs is provided on an "as is" and "as available" basis without warranties of any kind. We do not guarantee uninterrupted, secure, or error-free operations of generated websites, custom domains, or e-commerce storefront database services.
              </p>
            </section>
          </>
        )}
